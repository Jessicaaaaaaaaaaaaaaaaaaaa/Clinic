...
namespace FinalCourseRegistrationMVC.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2, null, 2, 1, "Fulltime" });

            migrationBuilder.InsertData(
                table: "Registration",
                columns: new[] { "RegistrationId", "CourseId", "InstructorId", "IntructorId", "StudentId", "Type" },
                values: new object[] { 2, 2, null, 2, 2, "Parttime" });

            migrationBuilder.InsertData(
                table: "Registration",
                columns: new[] { "RegistrationId", "CourseId", "InstructorId", "IntructorId", "StudentId", "Type" },
                values: new object[] { 3, 1, null, 1, 3, "Fulltime" });
