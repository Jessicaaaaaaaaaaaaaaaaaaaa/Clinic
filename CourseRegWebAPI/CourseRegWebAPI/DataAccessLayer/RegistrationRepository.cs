...
namespace CourseRegWebAPI.DataAccessLayer
{
    ...
    {
        private readonly CourseRegContext _context;

        public RegistrationRepository(CourseRegContext context)
        {
            _context = context;
        }
        ...
        public Student GetCourseId(int CourseId)
        {
            throw new NotImplementedException();
        }
        ...
        public Student GetInstructorId(int InstructorId)
        {
            throw new NotImplementedException();
        }

        public Student GetRegistrationId(int RegistrationId)
        {
            throw new NotImplementedException();
        }
        ...
        void IRegistrationRepository.UpdateRegistration(Registration registration)
        {
            throw new NotImplementedException();
        }
    }
